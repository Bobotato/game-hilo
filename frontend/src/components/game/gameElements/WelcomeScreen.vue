...
.welcome-component {
    display: grid;
    grid-template-rows: [welcome-message] auto [welcome-message-2] auto [take-credit-prompt] auto [image] auto;
    place-items: center;
}
